...
Operational Performance: A pie chart showing the ratio of "On Time" vs. "Delayed" patient attendance.

Departmental Referrals: Analysis of which departments (General Practice, Orthopedics, etc.) receive the most referrals from the ER.
...
🚀 How to Use
Filter by Date: Use the sidebar to toggle between months (January - December).

Yearly Comparison: Use the top toggle to switch between 2023 and 2024 data.

Cross-Filtering: Click on specific age groups or departments to see how they impact wait times and admission statuses.

📝 Key Findings
The "None" referral category is the largest, suggesting many patients visit the ER for non-specialized issues.

Wait time delays (62%) correlate with peak hours/months, suggesting a need for better staffing during high-volume periods.

The 0-9 age group represents one of the highest patient volumes, indicating a need for strong pediatric ER support.
